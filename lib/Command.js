...
var commands = {
    'click': require('./commands/click.js'),
    'config': require('./commands/config.js'),
    'contains': require('./commands/contains.js'),
    'cookie': require('./commands/cookie.js'),
    'data': require('./commands/data.js'),
    'delay': require('./commands/delay.js'),
    'do': require('./commands/do.js'),
    'done': require('./commands/done.js'),
    'fail': require('./commands/fail.js'),
    'filter': require('./commands/filter.js'),
    'find': require('./commands/find.js'),
    'follow': require('./commands/follow.js'),
    'get': require('./commands/get.js'),
    'header': require('./commands/header.js'),
    'headers': require('./commands/headers.js'),
    'if': require('./commands/if.js'),
    'learn': require('./commands/learn.js'),
    'login': require('./commands/login.js'),
    'match': require('./commands/match.js'),
    'paginate': require('./commands/paginate.js'),
    'parse': require('./commands/parse.js'),
    'pause': require('./commands/pause.js'),
    'proxy': require('./commands/proxy.js'),
    'resume': require('./commands/resume.js'),
    'rewrite': require('./commands/rewrite.js'),
    'set': require('./commands/set.js'),
    'stop': require('./commands/stop.js'),
    'submit': require('./commands/submit.js'),
    'success': require('./commands/success.js'),
    'then': require('./commands/then.js'),
    'train': require('./commands/train.js'),
    'trigger': require('./commands/trigger.js'),
    'use': require('./commands/use.js'),
    'using': require('./commands/using.js'),
};
...
Object.keys(commands).forEach(function (file) {
    var command = commands[file];
    if (typeof command === 'object') {
        Object.keys(command).forEach(function (name) {
            contextCommand(name, command[name]);
        });
    } else {
        runtimeCommand(file, command);
    }
});
